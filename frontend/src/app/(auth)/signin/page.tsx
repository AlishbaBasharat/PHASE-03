...
import { Mail, Lock, ShieldCheck, Terminal, Zap } from 'lucide-react';
      ...
      <div className="relative w-full max-w-[340px] z-10">
        <div className="bg-[#111114] border border-white/5 rounded-[2rem] p-8 shadow-2xl overflow-hidden box-border">
          ...
          <div className="mb-8 text-center">
            ...
            <h2 className="text-lg font-black text-white uppercase italic tracking-tight leading-none">Establish Link</h2>
            <p className="text-[8px] text-slate-500 font-bold uppercase tracking-widest mt-2">Mission Protocol v3.2</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 w-full">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-purple-600 hover:bg-purple-500 disabled:opacity-50 text-white font-black uppercase tracking-[0.2em] text-[9px] py-4 rounded-xl shadow-lg transition-all active:scale-95 flex items-center justify-center gap-2 mt-2 h-12"
            >
              {isLoading ? <div className="w-4 h-4 border-2 border-white/20 border-t-white rounded-full animate-spin"></div> : <Terminal size={12} />}
          ...
          <div className="mt-8 pt-6 border-t border-white/5 text-center">
            <p className="text-[9px] font-bold text-slate-600 uppercase tracking-widest">
              New Operator?{' '}
              <Link href="/signup" className="text-purple-500 ml-1 underline underline-offset-4">
                Register
              </Link>
            </p>
          </div>
